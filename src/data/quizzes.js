...
export const QUIZ_CATEGORIES = [
  ...
  },
  {
    ...
    description: {
      en: 'Smartphones, Android, OS, AI, and systems',
      uz: 'Smartfonlar, Android, OT, IT va tizimlar',
      ru: 'Смартфоны, Android, ОС, IT и системы',
    },
    difficulty: 'All Levels',
    color: '#06B6D4',
  ...
  },
  {
    ...
    description: {
      en: 'Football, Olympic games, records and legends',
      uz: 'Futbol, Olimpiada o\'yinlari, rekordlar va afsonalar',
      ru: 'Футбол, Олимпийские игры, рекорды и легенды',
    },
    difficulty: 'All Levels',
    color: '#10B981',
  ...
  },
  {
    ...
    description: {
      en: 'Ancient empires, world history, and civilizations',
      uz: 'Qadimgi imperiyalar, jahon tarixi va sivilizatsiyalar',
  ...
  },
  {
    ...
    description: {
      en: 'Physics, chemistry, astronomy, and biology',
      uz: 'Fizika, kimyo, astronomiya va biologiya',
      ru: 'Физика, химия, астрономия и биология',
    },
    difficulty: 'All Levels',
    color: '#8B5CF6',
  ...
  },
  {
    ...
    description: {
      en: 'Fine arts, cinema, music, and world traditions',
      uz: 'Tasviriy san\'at, kino, musiqa va jahon an\'analari',
      ru: 'Искусство, кино, музыка и мировые традиции',
    },
    difficulty: 'All Levels',
    color: '#EC4899',
  ...
  programming: [
    ...
    },
    {
      ...
      question: {
        ...
        uz: 'Android operatsion tizimi qaysi kompaniya tomonidan yaratilgan?',
        ru: 'Какой компанией была создана операционная система Android?',
      },
      options: {
        en: ['Apple', 'Google', 'Microsoft', 'Samsung'],
        uz: ['Apple', 'Google', 'Microsoft', 'Samsung'],
        ru: ['Apple', 'Google', 'Microsoft', 'Samsung'],
      },
      correctAnswer: 1,
      difficulty: 'Easy',
    },
...
// Aliases for categories so all 6 categories are accessible
QUIZ_QUESTIONS.technology = QUIZ_QUESTIONS.programming;
QUIZ_QUESTIONS.history = QUIZ_QUESTIONS.general;
QUIZ_QUESTIONS.culture = QUIZ_QUESTIONS.general;
